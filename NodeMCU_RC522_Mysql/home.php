...
<html>
	<head>
		...
		<title>Home | Car Parking System</title>
	...
	<nav class="navbar navbar-expand-lg navbar bg-dark" data-bs-theme="dark">
		...
		<ul class="topnav">
			<li style="margin-right: 140px;"><a class="active" href="home.php">Home</a></li>
		...
		<br>
		<h3>Welcome Car Parking System</h3>
		
		<img src="home.jpeg" alt="" style="width:55%;">
