					...
					<tr>
						<td bgcolor="#f9f9f9">
							<table width="452"  border="0" align="center" cellpadding="5"  cellspacing="0">
								...
								<tr>
									<td align="left" class="lf">Car Number</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['carnumber'];?></td>
								</tr>
								<tr bgcolor="#f2f2f2">
									<td align="left" class="lf">Date and Time </td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['dateandtime'];?></td>
								</tr>
								<tr>
